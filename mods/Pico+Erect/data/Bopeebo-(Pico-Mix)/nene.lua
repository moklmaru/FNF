...
function onCreatePost()
			for i = 0, getProperty('strumLineNotes.length') - 1 do
				if i >= 0 and i <= 3 then 
					if i == 0 then
						setProperty('strumLineNotes.members['..i..'].x', defaultOpponentStrumX0 - 40)
					elseif i == 1 then
						setProperty('strumLineNotes.members['..i..'].x', defaultOpponentStrumX1 - 5)
					elseif i == 2 then
						setProperty('strumLineNotes.members['..i..'].x', defaultOpponentStrumX2 - 10)
					elseif i == 3 then
						setProperty('strumLineNotes.members['..i..'].x', defaultOpponentStrumX3 - 15)
					end
				elseif i >= 4 and i <= 7 then 
					if i == 4 then
						setProperty('strumLineNotes.members['..i..'].x', defaultPlayerStrumX0 - 40)
					elseif i == 5 then
						setProperty('strumLineNotes.members['..i..'].x', defaultPlayerStrumX1 - 5)
					elseif i == 6 then
						setProperty('strumLineNotes.members['..i..'].x', defaultPlayerStrumX2 - 10)
					elseif i == 7 then
						setProperty('strumLineNotes.members['..i..'].x', defaultPlayerStrumX3 - 15)
					end
				end
			end
end
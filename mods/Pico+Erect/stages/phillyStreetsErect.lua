...
--
createInstance('333', 'flixel.addons.display.FlxBackdrop', {nil, axis})
loadGraphic('333', 'phillyStreets/erect/mistFront')
setScrollFactor('333', 0.3, 0.3)
scaleObject('333',1.2,1.2)
setProperty('333.alpha',0.8)
addInstance('333')
setProperty('333.velocity.x',150)
setProperty('333.y',-400)
...
createInstance('mistFront', 'flixel.addons.display.FlxBackdrop', {nil, axis})
loadGraphic('mistFront', 'phillyStreets/erect/mistFront')
setScrollFactor('mistFront', 0.3, 0.3)
scaleObject('mistFront',1.2,1.2)
setProperty('mistFront.alpha',0.5)
addInstance('mistFront')
setProperty('mistFront.velocity.x',-200)
setProperty('mistFront.y',-200)
setProperty('mistFront.color',0x5c5c5c)
setProperty('mistFront.blend',0)
setObjectOrder('mistFront',20)
--

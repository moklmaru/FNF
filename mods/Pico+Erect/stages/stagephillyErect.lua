function onCreate()
	precacheSound('train_passes')
		...
		makeLuaSprite('sky', 'philly/erect/sky', -100, -20);
		setScrollFactor('sky', 0.1, 0.1);

		makeLuaSprite('behindTrain', 'philly/erect/behindTrain', -40, 20);
  ...
  makeAnimatedLuaSprite('light', 'philly/erect/win-erect', -10, 0)

...
function onCreate()
	...
	makeLuaSprite('tankSky', 'tank/tankSky', -400, -400);
	setScrollFactor('tankSky', 0, 0);

	makeLuaSprite('tankBuildings', 'tank/tankBuildings', -200, 0);
	setScrollFactor('tankBuildings', 0.3, 0.3);
	scaleObject('tankBuildings', 1.1, 1.1);

	makeLuaSprite('tankRuins', 'tank/tankRuins', -200, 0);
	setScrollFactor('tankRuins', 0.35, 0.35);
	scaleObject('tankRuins', 1.1, 1.1);

	makeAnimatedLuaSprite('tankWatchtower', 'tank/tankWatchtower', 100, 50);
	...
	makeLuaSprite('tankGround', 'tank/tankGround', -420, -150);
	...
	if not lowQuality then
		makeLuaSprite('tankClouds', 'tank/tankClouds', getRandomInt(-700, -100), getRandomInt(-20, 20));
		setScrollFactor('tankClouds', 0.1, 0.1);
		setProperty('tankClouds.velocity.x', getRandomInt(5, 15));

		makeLuaSprite('tankMountains', 'tank/tankMountains', -300, -20);
		setScrollFactor('tankMountains', 0.2, 0.2);
		scaleObject('tankMountains', 1.2, 1.2);

		makeAnimatedLuaSprite('smokeLeft', 'tank/smokeLeft', -200, -100);
		addAnimationByPrefix('smokeLeft', 'idle', 'SmokeBlurLeft');
		setScrollFactor('smokeLeft', 0.4, 0.4);

		makeAnimatedLuaSprite('smokeRight', 'tank/smokeRight', 1100, -100);

...
function onCreatePost()
	BatAllowed = false
	makeAnimatedLuaSprite('secondbiker', 'stages/week7b/bgGuys', getProperty('gf.x') -100, 275);
	...
	makeAnimatedLuaSprite('firstbiker', 'stages/week7b/bgGuys', getProperty('gf.x') +450, 300);

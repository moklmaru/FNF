function onCreate()
	makeLuaSprite('skyBG', 'limoErect/limoErect', -220, -80)
	setScrollFactor('skyBG', 0.1, 0.1)
	
	makeAnimatedLuaSprite('bgLimo', 'limoErect/bgLimo', -150, 480)
	...
	makeAnimatedLuaSprite('limo', 'limoErect/limoDrive', -120, 550)
	...
	makeAnimatedLuaSprite('shooting star', 'limoErect/shooting star', 450, 0)
...
function onCreatePost()
	...
	loadGraphic('Sky', 'limoErect/mistBack')
	addInstance('Sky')
...
loadGraphic('mist2', 'limoErect/mistBack')
addInstance('mist2')
...
loadGraphic('mist3', 'limoErect/mistMid')
addInstance('mist3')

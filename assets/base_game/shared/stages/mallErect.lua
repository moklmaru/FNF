function onCreate()
	makeLuaSprite('ulin', 'erect/bgWalls', -1000, -500)
	setScrollFactor('ulin', 0.2, 0.2)
	setGraphicSize('ulin', getProperty('ulin.width') * 0.8)
	updateHitbox('ulin')

		makeAnimatedLuaSprite('upperBoppers', 'erect/upperBop', -240, -90)
		...
		makeLuaSprite('bgEscalator', 'erect/bgEscalator', -1100, -600)
		setScrollFactor('bgEscalator', 0.3, 0.3)
		setGraphicSize('bgEscalator', getProperty('bgEscalator.width') * 0.9)
		updateHitbox('bgEscalator')

		makeLuaSprite('tree', 'erect/christmasTree', 370, -250);
		setScrollFactor('tree', 0.40, 0.40);
	
	makeAnimatedLuaSprite('bottomBoppers', 'erect/bottomBop', -300, 140)

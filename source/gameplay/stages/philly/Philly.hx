package gameplay.stages.philly;

import gameplay.stages.philly.PhillyTrain;
import gameplay.stages.philly.PhillyGlowGradient;
import gameplay.stages.philly.PhillyGlowParticle;
...
class Philly extends BaseStage
{
	...
	override function eventPushed(event:gameplay.notes.Note.EventNote)
	{
		switch(event.event)
		{
			case "Philly Glow":

...
class OptionsState extends FunkinState
{
	...
	function openSelectedSubstate(label:String) {
		...
		{
			case 'Note Colors':
				openSubState(new menu.options.NotesColorSubState());
			case 'Controls':
				openSubState(new menu.options.ControlsSubState());
			case 'Graphics':
				openSubState(new menu.options.GraphicsSettingsSubState());
			case 'Visuals':
				openSubState(new menu.options.VisualsSettingsSubState());
			case 'Gameplay':
